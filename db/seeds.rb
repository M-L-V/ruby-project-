...
publisher1 = Publisher.new({
  "name" => "Penguin Books",
  "contact_details" => "Uxbridge Road Ealing, London"
  })
...
publisher2 = Publisher.new({
  "name" => "HarperCollins",
  "contact_details" => "Westerhill Road, Bishopsbriggs, Glasgow"
  })
...
publisher3 = Publisher.new({
  ...
  "contact_details" => "The Strand, London"
  })
...
publisher4 = Publisher.new({
  ...
  "contact_details" => "Wimpole Street, London"
  })
